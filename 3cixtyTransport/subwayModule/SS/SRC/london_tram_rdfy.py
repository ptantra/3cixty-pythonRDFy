...
def main():
    ...
    inFileTube = '/Users/patrick/3cixty/codes/3cixtyTransport/subwayModule/IN/_' + strftime("%Y%m%d") + '/tram_ALL.csv'
    outFileTube = "/Users/patrick/3cixty/codes/3cixtyTransport/subwayModule/OUT/" + strftime("%Y%m%d") + "/tram_dirty" +".ttl"
