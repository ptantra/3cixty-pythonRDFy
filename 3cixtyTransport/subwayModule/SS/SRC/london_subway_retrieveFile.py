...
if not os.path.exists("subwayModule/IN/_" + strftime("%Y%m%d")):
    os.makedirs(strftime("subwayModule/IN/_" + strftime("%Y%m%d")))
...
bakerloo = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[0] + "_output.csv"))
central = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[1] + "_output.csv"))
circle = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[2] + "_output.csv"))
district = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[3] + "_output.csv"))
hammersmith_city = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[4] + "_output.csv"))
jubilee = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[5] + "_output.csv"))
metropolitan= DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[6] + "_output.csv"))
northern = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[7] + "_output.csv"))
picadilly = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[8] + "_output.csv"))
victoria =  DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[9] + "_output.csv"))
waterloo_city = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[10] + "_output.csv"))
dlr = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[11] + "_output.csv"))
tfl_rail = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[12] + "_output.csv"))
tram = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[13] + "_output.csv"))
london_overground = DataFrame(
    pd.read_csv("subwayModule/IN/" + strftime("%Y%m%d") + "/subwayLine_" + lineId[14] + "_output.csv"))
...
lines.to_csv("subwayModule/IN/_"+ strftime("%Y%m%d") +"/subwayLine_" + "ALL.csv", index=False)
tram.to_csv("subwayModule/IN/_"+ strftime("%Y%m%d") +"/tram_" + "ALL.csv", index=False)
dlr.to_csv("subwayModule/IN/_"+ strftime("%Y%m%d") +"/dlr_" + "ALL.csv", index=False)
london_overground.to_csv("subwayModule/IN/_"+ strftime("%Y%m%d") +"/londonOverground_" + "ALL.csv", index=False)

print lines

#shutil.rmtree("subwayModule/IN/"+ strftime("%Y%m%d")) #declutter, remove all temporary files containing line information and metadata. Comment to scrutinise content.
