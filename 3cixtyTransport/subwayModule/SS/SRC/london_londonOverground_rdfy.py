...
def createTubeSGraph(arg,g):
    ...
    g.add((singleStation, locationOnt.businessType, URIRef("http://data.linkedevents.org/kos/tfl/subway")))
...
def main():
    ...
    inFileTube = '/Users/patrick/3cixty/codes/3cixtyTransport/subwayModule/IN/_' + strftime("%Y%m%d") + '/londonOverground_ALL.csv'
    outFileTube = "/Users/patrick/3cixty/codes/3cixtyTransport/subwayModule/OUT/" + strftime("%Y%m%d") + "/londonOverground_dirty" +".ttl"
