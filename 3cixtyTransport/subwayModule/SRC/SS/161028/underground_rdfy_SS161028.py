...
def createStation(stationNameGUID): #createTubeGraph
    ...
    stationName = URIRef('http://data.linkedevents.org/transit/london/station/%s') % stationNameGUID
    return stationName
...
def main():
    ...
    inFileTube = 'IN/validation/underground_validated.csv'
    outFileTube = 'OUT/underground_dirty.ttl'
