...
for lineNo in xrange(len(lineId)):
    ...
    outXmlLines = "DATA/subwayLine_"+lineId[lineNo] +".xml"
    ...
    def apiJsonCsv(inUrlLines):
        ...
        fMain = csv.writer(open("DATA/subwayLine_" + lineId[lineNo] + ".csv", "wb+"))
        ...
        fWifi= csv.writer(open("DATA/subwayLine_" + lineId[lineNo] + "_wifi.csv", "wb+"))
        fWifi.writerow(['wifi'])
        ...
        fZone = csv.writer(open("DATA/subwayLine_" + lineId[lineNo] + "_zone.csv", "wb+"))
        fZone.writerow(['zone'])
        ...
        fAddress = csv.writer(open("DATA/subwayLine_" + lineId[lineNo] + "_address.csv", "wb+"))
    ...
    subway = DataFrame(pd.read_csv("DATA/subwayLine_" + lineId[lineNo] + ".csv"))
    subwayWifi = DataFrame(pd.read_csv("DATA/subwayLine_" + lineId[lineNo] + "_wifi.csv"))
    subwayZone = DataFrame(pd.read_csv("DATA/subwayLine_" + lineId[lineNo] + "_zone.csv"))
    subwayAddress = DataFrame(pd.read_csv("DATA/subwayLine_" + lineId[lineNo] + "_address.csv"))

    join = subway.join([subwayWifi, subwayZone, subwayAddress])
    #print join
    join.to_csv("DATA/subwayLine_" + lineId[lineNo] + "_output.csv", index=False)

bakerloo = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[0] + "_output.csv"))
central = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[1] + "_output.csv"))
circle = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[2] + "_output.csv"))
district = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[3] + "_output.csv"))
hammersmith_city = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[4] + "_output.csv"))
jubilee = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[5] + "_output.csv"))
metropolitan= DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[6] + "_output.csv"))
northern = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[7] + "_output.csv"))
picadilly = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[8] + "_output.csv"))
victoria =  DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[9] + "_output.csv"))
waterloo_city = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[10] + "_output.csv"))
dlr = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[11] + "_output.csv"))
tfl_rail = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[12] + "_output.csv"))
tram = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[13] + "_output.csv"))
london_overground = DataFrame(
    pd.read_csv("DATA/subwayLine_" + lineId[14] + "_output.csv"))
...
lines.to_csv("DATA/subwayLine_" + "ALL.csv", index=False)
tram.to_csv("DATA/tram_" + "ALL.csv", index=False)
dlr.to_csv("DATA/dlr_" + "ALL.csv", index=False)
london_overground.to_csv("DATA/overground_" + "ALL.csv", index=False)
