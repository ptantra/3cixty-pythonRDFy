...
var metaStopTypes = 'https://api.tfl.gov.uk/StopPoint/Meta/stoptypes'
var mateStopTypesArray = [NaptanBusCoachStation,NaptanBusWayPoint,NaptanMarkedPoint,NaptanMetroAccessArea,NaptanMetroEntrance,NaptanMetroPlatform,
NaptanMetroStation,NaptanOnstreetBusCoachStopCluster,NaptanOnstreetBusCoachStopPair,
NaptanPrivateBusCoachTram,NaptanPublicBusCoachTram,NaptanRailAccessArea,NaptanRailEntrance,
NaptanRailPlatform,NaptanRailStation,NaptanSharedTaxi,NaptanTaxiRank,NaptanUnmarkedPoint,
TransportInterchange]
...
/*
var api_urlStream = 'http://countdown.api.tfl.gov.uk/interfaces/ura/stream?Stopid=99,13551&ReturnList=Stoppointname,VehicleID,RegistrationNumber,L ineName,DestinationName,EstimatedTime,ExpireTime'
    var api_url = 'http://countdown.api.tfl.gov.uk/interfaces/ura/instant_V1'+ q_stopCode + q_directionId + q_returnListList;
    var q_stopCode = "?StopCode1=" + stopCode;
    var q_directionId = "&DirectionID=" + directionId;
    var q_returnList = "&ReturnList=" + 
    var returnList= 'StopCode1'+
    'StopCode2'+
    'StopPointName'+
    'LineName'+ 
    'DestinationText'+
 ...
 var api_urlStopPoint = 'https://api.tfl.gov.uk/StopPoint/'+naptans+'/Arrivals?app_id=5ee709d5&app_key=1739d498d997e956a2b80c62a8948ff0'  
