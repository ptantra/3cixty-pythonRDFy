...
def getUid(self,s,n): #+TICKED
    idencode=s.encode('utf-8')
    uid=uuid.uuid5(n, idencode)
    return uid

def convertProj(self,lon,lat): #+TICKED
...
def bindingPrefixes(self,prefixes):#+TICKED
    for key in prefixes:
