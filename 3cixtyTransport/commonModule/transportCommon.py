...
__author__ = 'casa'
# -*- coding: utf-8 -*-
import csv, zipfile, uuid, pyproj, re, os, fileinput, urllib, validators
from time import strftime
from rdflib import URIRef, Literal, Namespace, plugin, Graph, ConjunctiveGraph
from rdflib.store import Store
from collections import defaultdict

os.chdir('/Users/patrick/3cixty/codes/3cixtyTransport/commonModule/') # @patrick CASA Mac setup
print os.getcwd()
