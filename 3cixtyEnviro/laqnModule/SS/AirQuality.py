...
def createAirQualGraph(arg, g):
    ...
    g.add((measurePM10, rdfs.comment, Literal('CO2 measured in kiloton (kt)')))
    g.add((measurePM10, dcterms.description, Literal('CO2 measured in kiloton (kt)')))
    g.add((measurePM10, time.instance, Literal('2013', datatype=xsd.gYear)))
